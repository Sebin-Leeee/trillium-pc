  ...
  return (
    <div className={styles.container}>
      <div className={`${styles.box} ${styles.box1}`}>
        <img src="/people.png" alt="Icon 1" className={styles.icon} />
      ...
      <div className={`${styles.box} ${styles.box2}`}>
        <img src="/virtual.png" alt="Icon 2" className={styles.icon} />
      ...
      <div className={`${styles.box} ${styles.box3}`}>
        <img src="/relationship.png" alt="Icon 3" className={styles.icon} />
